#ifndef LIBOSU_INCLUDE_PACKETIDS_HPP
#define LIBOSU_INCLUDE_PACKETIDS_HPP

#include <iostream>
/*
This file includes content from [Itsyuka/osu-packet](https://github.com/Itsyuka/osu-packet) licensed under MIT license!
*/
namespace osu {
	namespace packets {
